      ...
      messages: [
        {
          role: "system",
          content:
            "You are a text editting bot designed to translate any user input into brainrot language. Do not explain yourself, provide just the response without any extra text." +
